...
/**
 * @Package: com.learning.apidesign.response
 * @Description: APIResponseController
 * @Author: Sammy
...
public class APIResponseController {
	...
	public String client(@RequestParam(value = "error", defaultValue = "0") int error) {
		String url = Arrays.asList("http://localhost:9898/apiresponse/server?userId=2",
				"http://localhost:9898/apiresponse/server2",
				"http://localhost:9898/apiresponse/server?userId=",
				"http://localhost:9898/apiresponse/server?userId=1").get(error);
		String response = "";
		try {
